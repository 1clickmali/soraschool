...
async function main() {
  ...
  const holidayTemplates = [
    // CÔTE D'IVOIRE
    { countryCode: 'CI', title: 'Rentrée scolaire', type: 'PUBLIC_HOLIDAY' as const, startMonth: 9, startDay: 1, endMonth: 9, endDay: 1, color: '#3B82F6' },
    ...
    { countryCode: 'CI', title: 'Fin d\'année scolaire', type: 'PUBLIC_HOLIDAY' as const, startMonth: 7, startDay: 1, endMonth: 7, endDay: 1, color: '#A855F7' },
    { countryCode: 'CI', title: 'Grandes vacances', type: 'VACATION' as const, startMonth: 7, startDay: 1, endMonth: 8, endDay: 31, color: '#22C55E' },
    // MALI
    { countryCode: 'ML', title: 'Rentrée scolaire', type: 'PUBLIC_HOLIDAY' as const, startMonth: 10, startDay: 1, endMonth: 10, endDay: 1, color: '#3B82F6' },
    ...
    // SÉNÉGAL
    { countryCode: 'SN', title: 'Rentrée scolaire', type: 'PUBLIC_HOLIDAY' as const, startMonth: 10, startDay: 3, endMonth: 10, endDay: 3, color: '#3B82F6' },
    ...
    // BURKINA FASO
    { countryCode: 'BF', title: 'Rentrée scolaire', type: 'PUBLIC_HOLIDAY' as const, startMonth: 10, startDay: 1, endMonth: 10, endDay: 1, color: '#3B82F6' },
    ...
    // BÉNIN
    { countryCode: 'BJ', title: 'Rentrée scolaire', type: 'PUBLIC_HOLIDAY' as const, startMonth: 10, startDay: 1, endMonth: 10, endDay: 1, color: '#3B82F6' },
    ...
    // NIGER
    { countryCode: 'NE', title: 'Rentrée scolaire', type: 'PUBLIC_HOLIDAY' as const, startMonth: 10, startDay: 1, endMonth: 10, endDay: 1, color: '#3B82F6' },
    ...
    // GUINÉE
    { countryCode: 'GN', title: 'Rentrée scolaire', type: 'PUBLIC_HOLIDAY' as const, startMonth: 10, startDay: 1, endMonth: 10, endDay: 1, color: '#3B82F6' },
    ...
    // TOGO
    { countryCode: 'TG', title: 'Rentrée scolaire', type: 'PUBLIC_HOLIDAY' as const, startMonth: 10, startDay: 1, endMonth: 10, endDay: 1, color: '#3B82F6' },
    ...
    // GHANA
    { countryCode: 'GH', title: 'Rentrée scolaire (1er trimestre)', type: 'PUBLIC_HOLIDAY' as const, startMonth: 9, startDay: 5, endMonth: 9, endDay: 5, color: '#3B82F6' },
    ...
    // NIGERIA
    { countryCode: 'NG', title: 'Rentrée scolaire', type: 'PUBLIC_HOLIDAY' as const, startMonth: 9, startDay: 1, endMonth: 9, endDay: 1, color: '#3B82F6' },
    ...
    // GAMBIE
    { countryCode: 'GM', title: 'Rentrée scolaire', type: 'PUBLIC_HOLIDAY' as const, startMonth: 9, startDay: 1, endMonth: 9, endDay: 1, color: '#3B82F6' },
    ...
    // SIERRA LEONE
    { countryCode: 'SL', title: 'Rentrée scolaire', type: 'PUBLIC_HOLIDAY' as const, startMonth: 9, startDay: 1, endMonth: 9, endDay: 1, color: '#3B82F6' },
    ...
    // LIBERIA
    { countryCode: 'LR', title: 'Rentrée scolaire', type: 'PUBLIC_HOLIDAY' as const, startMonth: 9, startDay: 1, endMonth: 9, endDay: 1, color: '#3B82F6' },
    ...
    // CAP-VERT
    { countryCode: 'CV', title: 'Rentrée scolaire', type: 'PUBLIC_HOLIDAY' as const, startMonth: 9, startDay: 15, endMonth: 9, endDay: 15, color: '#3B82F6' },
    ...
    // GUINÉE-BISSAU
    { countryCode: 'GW', title: 'Rentrée scolaire', type: 'PUBLIC_HOLIDAY' as const, startMonth: 10, startDay: 1, endMonth: 10, endDay: 1, color: '#3B82F6' },
    ...
    // MAURITANIE
    { countryCode: 'MR', title: 'Rentrée scolaire', type: 'PUBLIC_HOLIDAY' as const, startMonth: 10, startDay: 1, endMonth: 10, endDay: 1, color: '#3B82F6' },
